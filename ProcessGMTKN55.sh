...
if ((weight_Type == 1)) ; then
    ...
    GMTKN55_info=(
      ...
      "G21IP       36    257.61     0.1    0    1.63     3.92  "
      "G2RC        25     51.26     1.0    0    1.12     5.67  "
      "HEAVYSB11   11     58.02     1.0    0    2.73     2.33  "
      "NBPRC       12     27.71     1.0    0    2.32     2.74  "
      "PA26        26    189.05     0.1    0    1.98     3.21  "
      "RC21        21     35.70     1.0    0    1.45     4.40  "
      "SIE4x4      16     33.72     1.0    0    0.469   13.6   "
      "TAUT15      15      3.05    10.0    0    5.80     1.10  "
      "W4-11      140    306.91     0.1    0    1.07     5.92  "
      "YBDE18      18     49.28     1.0    0    2.55     2.50  "
      "BSR36       36     16.20     1.0    1    2.03     3.14  "
      "C60ISO       9     98.25     0.1    1    1.19     5.34  "
      "CDIE20      20      4.06    10.0    1    5.75     1.11  "
      "DARC        14     32.47     1.0    1    1.44     4.41  "
      "ISO34       34     14.57     1.0    1    4.49     1.42  "
      "ISOL24      24     21.92     1.0    1    1.99     3.19  "
      "MB16-43     43    468.39     0.1    1    0.329   19.3   "
      "PArel       20      4.63    10.0    1    5.51     1.16  "
      "RSE43       43      7.60     1.0    1    5.27     1.21  "
      "BH76        76     18.61     1.0    2    1.53     4.17  "
      "BHDIV10     10     45.33     1.0    2    1.66     3.83  "
      "BHPERI      26     20.87     1.0    2    2.29     2.78  "
      "BHROT27     27      6.27    10.0    2   11.0      0.581 "
      "INV24       24     31.85     1.0    2    4.41     1.44  "
      "PX13        13     33.36     1.0    2    1.18     5.40  "
      "WCPT18      18     34.99     1.0    2    1.77     3.59  "
      "ADIM6        6      3.36    10.0    3   36.8      0.173 "
      "AHB21       21     22.49     1.0    3    6.24     1.02  "
      "CARBHB12    12      6.04    10.0    3    5.50     1.16  "
      "CHB6         6     26.79     1.0    3    4.14     1.54  "
      "HAL59       59      4.59    10.0    3    9.63     0.661 "
      "HEAVY28     28      1.24    10.0    3   14.0      0.456 "
      "IL16        16    109.04     0.1    3   11.5      0.554 "
      "PNICO23     23      4.27    10.0    3    7.86     0.810 "
      "RG18        18      0.58    10.0    3   29.9      0.213 "
      "S22         22      7.30    10.0    3   13.5      0.470 "
      "S66         66      5.47    10.0    3   18.4      0.346 "
      "WATER27     27     81.14     0.1    3    1.43     4.44  "
      "ACONF       15      1.83    10.0    4   61.2      0.104 "
      "Amino20x4   80      2.44    10.0    4   22.6      0.281 "
      "BUT14DIOL   64      2.80    10.0    4   30.0      0.212 "
      "ICONF       17      3.27    10.0    4   20.0      0.318 "
      "IDISP        6     14.22     1.0    4    2.50     2.54  "
      "MCONF       51      4.97    10.0    4   21.2      0.300 "
      "PCONF21     18      1.62    10.0    4    8.66     0.735 "
      "SCONF       17      4.60    10.0    4   19.1      0.334 "
      "UPU23       23      5.72    10.0    4   10.1      0.629 "
    )
elif ((weight_Type == 2)) ; then
    ### WTMAD-4 Weights determined using ALL-115 Dataset
    GMTKN55_info=(
      "AL2X6        6     35.88     1.0    0    2.67     2.38  "
      "ALK8         8     62.60     1.0    0    1.30     4.91  "
# outlier1 = outliers calculated via ratio method
declare -A outlier1
for j in "${!args[@]}"; do
    # Dimension 1 (will index with k) stores the following information:
    outlier1["0,$j"]=0  # k=0 : N<0.5 (Number of MADs <= 0.5 * meanMAD from the WTMAD4 functionals on that GMTKN55 subset
    outlier1["1,$j"]=0  # k=1 : N<1.0
    outlier1["2,$j"]=0  # k=2 : N>1.0
    outlier1["3,$j"]=0  # k=3 : N>1.5
    outlier1["4,$j"]=0  # k=4 : N>2.0
    outlier1["5,$j"]=0  # k=5 : N>3.0
    # k=6 : min, calculated by mad_i/meanMAD_i, (Initialized to i=0 value)
    outlier1["6,$j"]=$(echo "${mad_array["$index_GMTKN55,0,$j"]} / ${meanMADs["$index_GMTKN55,0"]}" | bc -l)
    outlier1["7,$j"]=0  # k=7 : index of min
    # k=8 : max, calculated by mad_i/meanMAD_i, (Initialized to i=0 value)
    outlier1["8,$j"]=$(echo "${mad_array["$index_GMTKN55,0,$j"]} / ${meanMADs["$index_GMTKN55,0"]}" | bc -l)
    outlier1["9,$j"]=0  # k=9 : index of max
done
# outlier2 = outliers calculated via difference method
declare -A outlier2
for j in "${!args[@]}"; do
    # Dimension 1 (will index with k) stores the following information:
    outlier2["0,$j"]=0  # k=0 : N<-5.0 (Number of MADs - meanMADs < -5.0 kcal/mol from the WTMAD4 functionals on that GMTKN55 subset
    outlier2["1,$j"]=0  # k=1 : N<-4.0
    outlier2["2,$j"]=0  # k=2 : N<-3.0
    outlier2["3,$j"]=0  # k=3 : N<-2.0
    outlier2["4,$j"]=0  # k=4 : N<-1.0
    outlier2["5,$j"]=0  # k=5 : N<=0.0
    outlier2["6,$j"]=0  # k=6 : N>0.0
    outlier2["7,$j"]=0  # k=7 : N>1.0
    outlier2["8,$j"]=0  # k=8 : N>2.0
    outlier2["9,$j"]=0  # k=9 : N>3.0
    outlier2["10,$j"]=0 # k=10: N<4.0
    outlier2["11,$j"]=0 # k=11: N>5.0
    # k=12: min, calculated by mad_i-meanMAD_i, (Initialized to i=0 value)
    outlier2["12,$j"]=$(echo "${mad_array["$index_GMTKN55,0,$j"]} - ${meanMADs["$index_GMTKN55,0"]}" | bc -l)
    outlier2["13,$j"]=0 # k=13: index of min
    # k=14: max, calculated by mad_i-meanMAD_i, (Initialized to i=0 value)
    outlier2["14,$j"]=$(echo "${mad_array["$index_GMTKN55,0,$j"]} - ${meanMADs["$index_GMTKN55,0"]}" | bc -l)
    outlier2["15,$j"]=0 # k=15: index of max
done

if ((print_outlier_analysis == 1)) ; then
    if ((print_progress == 1)) ; then echo "... OUTLIER ANALYSIS" ; fi
    # Calculate Outlier1, ratio version
    for j in "${!args[@]}" ; do
        for (( i=0 ; i<subsets_total[$index_GMTKN55] ; i++ )) ; do
            ...
            # Check for min
            if (( $(echo "$mad_ratio < ${outlier1["6,$j"]}" | bc -l) )) ; then
                outlier1["6,$j"]=$mad_ratio
                outlier1["7,$j"]=$i
            fi
            # Check for max
            if (( $(echo "$mad_ratio > ${outlier1["8,$j"]}" | bc -l) )) ; then
                outlier1["8,$j"]=$mad_ratio
                outlier1["9,$j"]=$i
            fi
            ...
            # for k in {0..9} ; do
            #     echo "outlier1[$k,$j] = ${outlier1["$k,$j"]}"
            # done
        done
    done
    # Calculate Outlier2, difference version
    for j in "${!args[@]}" ; do
        for (( i=0 ; i<subsets_total[$index_GMTKN55] ; i++ )) ; do

            #The MAD value to meanMAD ratio for subset $i is:
            mad_diff=$(echo "${mad_array["$index_GMTKN55,$i,$j"]} - ${meanMADs["$index_GMTKN55,$i"]}" | bc -l)

            # Now check mad_diff for min, max, N<, and N> values.
            # This could be made more efficient by not using bc and using intelligent searching but lets keep it simple

            # Check N<-5.0
            if (( $(echo "$mad_diff < -5.0" | bc -l) )) ; then
                ((outlier2["0,$j"]++))
            fi
            # Check N<-4.0
            if (( $(echo "$mad_diff < -4.0" | bc -l) )) ; then
                ((outlier2["1,$j"]++))
            fi
            # Check N<-3.0
            if (( $(echo "$mad_diff < -3.0" | bc -l) )) ; then
                ((outlier2["2,$j"]++))
            fi
            # Check N<-2.0
            if (( $(echo "$mad_diff < -2.0" | bc -l) )) ; then
                ((outlier2["3,$j"]++))
            fi
            # Check N<-1.0
            if (( $(echo "$mad_diff < -1.0" | bc -l) )) ; then
                ((outlier2["4,$j"]++))
            fi
            # Check N<=0.0
            if (( $(echo "$mad_diff <= 0.0" | bc -l) )) ; then
                ((outlier2["5,$j"]++))
            fi
            # Check N>0.0
            if (( $(echo "$mad_diff > 0.0" | bc -l) )) ; then
            ...
            # Check for min
            if (( $(echo "$mad_diff < ${outlier2["12,$j"]}" | bc -l) )) ; then
                outlier2["12,$j"]=$mad_diff
                outlier2["13,$j"]=$i
            fi
            # Check for max
            if (( $(echo "$mad_diff > ${outlier2["14,$j"]}" | bc -l) )) ; then
                outlier2["14,$j"]=$mad_diff
                outlier2["15,$j"]=$i
            fi
        done
    done
...
if ((print_outlier_analysis == 1)) ; then
    ...
    printf "%s\n" "  OUTLIER ANALYSIS  "
    printf "%s\n" "--------------------"
    # Print outliers determined via ratio.
    printf "%s\n" "** Ratio Outliers: N=mad_i/meanMAD_i"
    ...
    for j in "${!args[@]}" ; do
        ...
        printf "%-${cw}s " "${inFile%.*}"
        for (( k=0 ; k<6 ; k++ )) ; do
            printf "%-${cw}d " "${outlier1["$k,$j"]}"
        done
        printf "%-${cw}.2f " "${outlier1["6,$j"]}"
        printf "%-${cw}s "   "${subsets["$index_GMTKN55,${outlier1["7,$j"]}"]}"
        printf "%-${cw}.2f " "${outlier1["8,$j"]}"
        printf "%-${cw}s "   "${subsets["$index_GMTKN55,${outlier1["9,$j"]}"]}"
        printf "\n"
    done
    printf "\n"
    ...
    for j in "${!args[@]}" ; do
        ...
        printf "%-${cw}s "   "${subsets["$index_GMTKN55,${outlier2["13,$j"]}"]}"
        printf "%-${cw}.2f " "${outlier2["14,$j"]}"
        printf "%-${cw}s "   "${subsets["$index_GMTKN55,${outlier2["15,$j"]}"]}"
        printf "\n"
    done
    printf "\n"
